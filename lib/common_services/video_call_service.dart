...
// class VideoCallService {
//   static const String staticRoomName = "FlutterJitsiRoom123";
...
//       // For mobile (Android/iOS) - most basic configuration
//       var options = JitsiMeetingOptions(
//         room: roomName,
//       );
...
//   // Method to leave current meeting (useful for cleanup)
//   static Future<void> leaveMeeting() async {
//     try {
//       if (!kIsWeb) {
//         // Note: Check your jitsi_meet package documentation for the correct method
//         // Common alternatives: JitsiMeet.closeMeeting(), JitsiMeet.leave()
//         // await JitsiMeet.hangUp(); // This method might not exist in your version
//         debugPrint(
//             "Leave meeting called - implement based on your package version");
//       }
//     } catch (e) {
...
//   // Method to check if currently in a meeting
//   static Future<bool> isInMeeting() async {
//     try {
//       if (!kIsWeb) {
//         // This would require additional implementation in the jitsi_meet plugin
...
//   // Generate a unique room name (useful for private calls)
//   static String generateUniqueRoomName({String prefix = "Room"}) {
//     final timestamp = DateTime.now().millisecondsSinceEpoch;
//     final random = (timestamp % 10000).toString().padLeft(4, '0');
//     return "${prefix}_$random";
