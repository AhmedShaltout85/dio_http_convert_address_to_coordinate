...
//   void _startPeriodicFetch() {
//     const fetchInterval = Duration(minutes: 1);
//     _timer = Timer.periodic(fetchInterval, (Timer timer) {
//       getUsersBrokenPointsList.then((data) {
//         if (data.isEmpty) {
//           debugPrint("Data is empty, fetching again...");
...
//   // Update the approval status of a complaint
//   Future<void> _updateApprovalStatus(Map<String, dynamic> complaint) async {
//     try {
//       await DioNetworkRepos().updateLocAddIsApproved(complaint['address'], 1);
//       setState(() {
//         isApproved = 1;
//       });
//       _fetchData();

//       bool addressExists = await DioNetworkRepos()
//           .checkAddressExistsInTracking(complaint['address']);
//       if (addressExists) {
...
//                 isApproved = complaint['is_approved'];
...
//             ),
//           ),
//           if (complaint['handasah_name'] != null)
//             ListTile(
//               title: Padding(
//                 padding: const EdgeInsets.all(8.0),
//                 child: Row(
...
//                     ),
//                     _buildApprovalButton(complaint),
//                   ],
//                 ),
//               ),
//             ),
//           ListTile(
//             title: Text(
//               'الاحداثئات :  ${complaint['latitude']} , ${complaint['longitude']}',
//               textAlign: TextAlign.center,
//               style: const TextStyle(
//                 color: Colors.indigo,
//                 fontSize: 15,
...
//           ListTile(
//             title: Text(
//               'إسم المبلغ :  ${complaint['caller_name']}',
//               textAlign: TextAlign.center,
//               style: const TextStyle(
//                 color: Colors.indigo,
//                 fontSize: 15,
...
//           ListTile(
//             title: Text(
//               ' رقم هاتف المبلغ:  ${complaint['caller_phone']}',
//               textAlign: TextAlign.center,
//               style: const TextStyle(
//                 color: Colors.indigo,
//                 fontSize: 15,
...
//           ListTile(
//             title: Text(
//               'نوع الكسر :  ${complaint['broker_type']}',
//               textAlign: TextAlign.center,
//               style: const TextStyle(
//                 color: Colors.indigo,
//                 fontSize: 15,
...
//   // Build the approval button
//   Widget _buildApprovalButton(Map<String, dynamic> complaint) {
//     return isApproved == 0
//         ? TextButton(
//             style: const ButtonStyle(
//               backgroundColor: WidgetStatePropertyAll(Colors.orange),
//             ),
//             onPressed: () => _updateApprovalStatus(complaint),
//             child: const Text(
//               'قيد قبول الشكوى',
...
//   Widget _buildActionButtons(Map<String, dynamic> complaint) {
//     return Row(
//       mainAxisAlignment: MainAxisAlignment.center,
//       children: [
//         _buildIconButton(
...
//           onPressed: () {
//             if (kIsWeb) {
//               CustomBrowserRedirect.openInBrowser(complaint['gis_url']);
//             } else {
//               Navigator.push(
//                 context,
//                 MaterialPageRoute(
...
//           tooltip: 'جرد مخزن',
//           onPressed: () async {
//             var storeName = await DioNetworkRepos()
//                 .getStoreNameByHandasahName(complaint['handasah_name']);
//             DioNetworkRepos().excuteTempStoreQty(storeName['storeName']);
//             Navigator.push(
//               context,
//               MaterialPageRoute(
...
//           tooltip: 'إغلاق الشكوى',
//           onPressed: () {
//             DioNetworkRepos().updateLocAddIsFinished(complaint['address'], 1);
//             _fetchData();
//           },
//         ),
//       ],
